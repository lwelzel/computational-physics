...
```
cd existing_repo
git remote add origin https://gitlab.com/lukas_welzel/computational-physics.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/lukas_welzel/computational-physics/-/settings/integrations)
